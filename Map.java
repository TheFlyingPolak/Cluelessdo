...
public class Map {
    ...
    public void initialiseRooms() {
        ...
        rooms[9] = new Room(this, 21, 22, RoomType.ALLESANDROS, new Tile[] {tile[17][20]});
        
        rooms[RoomType.MC_KITCHEN.ordinal()].setSecretPassage(rooms[RoomType.ALLESANDROS.ordinal()]);
        rooms[RoomType.ALLESANDROS.ordinal()].setSecretPassage(rooms[RoomType.MC_KITCHEN.ordinal()]);
